          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                    <tr>
                      <td><h4>K&R GYM Club</h4></td>
                    </tr>
                    <tr>
                      <td>BaseCamp, Butwal, Rupandehi</td>
                    </tr>
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      <td><div class="text-center">KR-FC-<?php echo $row['user_id']; ?></div></td>
            ...
            <div class="row-fluid">
                ...
                <div class="pull-right">
                  ...
                  <img src="../img/report/stamp.png" width="150px;" alt=""><p class="text-center"></p> </div>
