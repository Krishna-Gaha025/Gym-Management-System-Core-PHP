            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness <small>- Rs.1500 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Sauna <small>- Rs.2000 per month</small></label>
                <label>
                  <input type="radio" value="Fitness_Sauna" name="services" />
                  Fitness + Sauna <small>- Rs.3000 per month</small></label>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="number" placeholder="1500" name="amount" class="span11">
                  </div>
              </div>
            </div>
