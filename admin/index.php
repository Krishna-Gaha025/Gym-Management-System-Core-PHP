  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class="fa fa-money" style="font-size:55x;color:green"></i> Total Earnings: Rs.<?php include'income-count.php' ?></a> </li>
            ...
            <div class="todo">
              ...
              <?php
                ...
                <li class='clearfix'>
                    ...
                    <div class='txt'> <?php echo 'ID '.$row["id"].' : '.$row["task_desc"]
                    ?> 
                    <?php if ($row["task_status"] == "Pending") { echo '<span class="by label label-info">Pending</span>';} else { echo '<span class="by label label-success">In Progress</span>'; }?></div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Krishna Gaha and Rabi Pandey</a> </div>
</div>
